...
declare module '#imports' {
  ...
  export { getSessions, saveSession, deleteSession, renameSession } from '../utils/storage';
  export { captureWindow, captureAllWindows, restoreSession } from '../utils/tab-operations';
  export { SavedTab, TabGroupColor, TabGroupData, WindowData, Session } from '../utils/types';
}
